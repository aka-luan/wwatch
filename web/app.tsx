            ...
            {navItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "flex w-full items-center gap-3 rounded-xl px-3 py-2 text-xs font-medium transition-all duration-150 cursor-pointer",
                    isActive
        ...
        <header className="sticky top-0 z-10 flex flex-wrap items-center justify-between gap-4 border-b border-white/6 bg-[#07080B]/95 px-7 py-3 backdrop-blur-md">
          ...
          <div className="flex items-center gap-1 rounded-xl border border-white/6 bg-[#0F1218] p-1 font-mono text-xs">
            {signalTabs.map((tab) => (
              <button
                ...
                className={cn(
                  "rounded-lg px-3 py-1.5 font-medium transition-all text-xs cursor-pointer",
                  activeSignalTab === tab
          ...
          <div className="flex items-center gap-2 font-mono text-xs">
            ...
            <button
              ...
              className="flex size-8 items-center justify-center rounded-xl border border-white/8 bg-[#0F1218] text-muted-foreground hover:text-white hover:bg-[#161B24] transition-colors cursor-pointer"
            ...
            <Button
              ...
              className="gap-1.5 bg-[#FF4D22] text-white hover:bg-[#FF380B] font-sans text-xs font-semibold rounded-xl px-3 py-1.5 shadow-md shadow-orange-950/40 cursor-pointer"
            >
